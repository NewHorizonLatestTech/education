! function(e) {
                    ...
                    try {
                        (a = new XMLHttpRequest) && (i = encodeURI(e + "?" + t), a.open("GET", i), a.onreadystatechange = function() {
                            ...
                            if (4 === a.readyState && 200 === a.status)
                                if ((e = a.responseText).code) c.error("XMLHttpRequest failure code: " + e.code + ", message: " + e.message);
                                else if (n) try {
                                n.call({}, e || {})
                            } catch (e) {
                            ...
                            c.error("XMLHttpRequest timeout event is fired."), c.diagPix(m, {
                                message: "timeout:" + r
                            })
        ...
        return t = e, (n = [{
            ...
            value: function() {
                ...
                return function() {
                    ...
                    } else c.error("apntag is not available. Cannot set keyword targeting for AppNexus.")
                }
            }
    ...
    var C = function() {
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                var t, n, r = this,
                    a = c.getQueryParamByName("iasprofileprobability") || 10,
                    i = {};
                b.chance(a) && setTimeout(function() {
                    t = r.requestStatusDict[e], n = t && t - e, i.responsetime = n, i.probability = a, c.diagPix(h, {
            ...
            value: function(e, t) {
                var n, r, a, i = this,
                    o = !1,
                    s = c.getQueryParamByName("iasendpoint") || "//pixel.adsafeprotected.com/services/pub",
            ...
            value: function() {
                ...
                if (window.context && window.context.domFingerprint.match(/amp/g) && (u = u || i.document.referrer), !A.isEmpty() && t) return e.push("anId=" + t), e.push(A.stringify()), e.push("wr=" + n), e.push("sr=" + o), e.push("sessionId=" + s), e.push("url=" + encodeURIComponent(u)), c.log("ad slots set: " + JSON.stringify(A)), c.log("anid set: " + t), e.join("&");
            ...
            this.commands.push = function(e) {
                ...
                try {
                    if (b.isFn(e)) n = e();
                        ...
                        if (!b.isObj(e)) throw Error("Items pushed into the queue must be a function or object");
                        n = e
                    }
                } catch (e) {
        ...
        function r() {
            ! function(e, t) {
                ...
                matchAdSlotHtml: function(e, t) {
                    if (!e) return null;
                    var n, r, a, i = this.updateUnsafeAdSlots(e, t),
