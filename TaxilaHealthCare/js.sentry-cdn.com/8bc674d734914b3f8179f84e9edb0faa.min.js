(function(c, u, v, n, p, e, z, A, w) {
    ...
    function B(a, l) {
        try {
            ...
            var h = c[n],
                k = c[p];
            for (b = 0; b < d.length; b++) d[b].e && h ? h.apply(c, d[b].e) : d[b].p && k && k.apply(c, [d[b].p])
        } catch (C) {
            console.error(C)
        }
    }
...
})(window, document, "script", "onerror", "onunhandledrejection", "Sentry", "8bc674d734914b3f8179f84e9edb0faa", "https://browser.sentry-cdn.com/7.0.0/bundle.min.js", {
